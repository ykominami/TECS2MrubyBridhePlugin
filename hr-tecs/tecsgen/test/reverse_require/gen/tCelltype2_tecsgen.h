...
/* 受け口関数プロトタイプ宣言 #_EPP_# */
/* sInit */
void         tCelltype2_eInit_initialize(tCelltype2_IDX idx);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define tCelltype2_N_CELL           (5)  /* セルの個数  #_NCEL_# */
...
/* 属性アクセスマクロ #_AAM_# */
#define tCelltype2_ATTR_no( p_that )	((p_that)->no)

#define tCelltype2_GET_no(p_that)	((p_that)->no)
...
#define ATTR_no              tCelltype2_ATTR_no( p_cellcb )
...
/* 受け口関数マクロ（短縮形） #_EPM_# */
#define eInit_initialize tCelltype2_eInit_initialize
