...
/* 受け口関数プロトタイプ宣言 #_EPP_# */
/* sAlloc */
ER           tAlloc_eA_alloc(tAlloc_IDX idx, int32_t sz, void** p);
...
#define tAlloc_N_CELL               (7)  /* セルの個数  #_NCEL_# */
...
/* 属性アクセスマクロ #_AAM_# */
#define tAlloc_ATTR_num( p_that )	((p_that)->num)

#define tAlloc_GET_num(p_that)	((p_that)->num)
...
#define ATTR_num             tAlloc_ATTR_num( p_cellcb )
