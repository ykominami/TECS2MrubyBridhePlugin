...
/* 属性・変数の配列 #_AVAI_# */
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_tUnmarshaler_sSample_eUnmarshalAndCallFunction_DES rTransparent_RPCPlugin__0_sSample_unmarshaler_eUnmarshalAndCallFunction_des;
const struct tag_tUnmarshaler_sSample_eUnmarshalAndCallFunction_DES rTransparent_RPCPlugin__0_sSample_unmarshaler_eUnmarshalAndCallFunction_des = {
