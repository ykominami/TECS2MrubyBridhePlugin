...
ER           tSimpleServer_eEnt_func6(tSimpleServer_IDX idx, const int8_t array[8]);
ER           tSimpleServer_eEnt_func7(tSimpleServer_IDX idx, const int8_t array2[8][4]);
...
ER           tSimpleServer_eEnt_func15(tSimpleServer_IDX idx, int8_t(* array1)[8]);
...
ER           tSimpleServer_eEnt_func27(tSimpleServer_IDX idx, int8_t(* array2)[8]);
...
ER           tSimpleServer_eEnt_func38(tSimpleServer_IDX idx, int8_t(** array2)[8]);
