...
#endif /* __cplusplus */
/* セル CB 型宣言 #_CCTPO_# */
typedef struct tag_tMainSingleArray_CB {
    /* call port #_TCP_# */
...
extern  tMainSingleArray_CB  tMainSingleArray_SINGLE_CELL_CB;


/* セルタイプのIDX型 #_CTIX_# */
typedef struct tag_tMainSingleArray_CB *tMainSingleArray_IDX;
...
#define N_CP_cTalker  (tMainSingleArray_SINGLE_CELL_CB.n_cTalker)
#define NCP_cTalker   (tMainSingleArray_SINGLE_CELL_CB.n_cTalker)
...
#define tMainSingleArray_cDefaultTalker_hello( ) \
	  tMainSingleArray_SINGLE_CELL_CB.cDefaultTalker->VMT->hello__T( \
	  tMainSingleArray_SINGLE_CELL_CB.cDefaultTalker )
#define tMainSingleArray_cTalker_hello( subscript ) \
	  tMainSingleArray_SINGLE_CELL_CB.cTalker[subscript]->VMT->hello__T( \
	  tMainSingleArray_SINGLE_CELL_CB.cTalker[subscript] )
#define tMainSingleArray_cTalker2_hello( subscript ) \
	  tMainSingleArray_SINGLE_CELL_CB.cTalker2[subscript]->VMT->hello__T( \
	  tMainSingleArray_SINGLE_CELL_CB.cTalker2[subscript] )
...
tMainSingleArray_cDefaultTalker_refer_to_descriptor(  )
{
    ...
    des.vdes = (struct tag_sHello_VDES *)tMainSingleArray_SINGLE_CELL_CB.cDefaultTalker;
    return des;
}
...
tMainSingleArray_cTalker_set_descriptor( int_t  i, Descriptor( sHello ) des )
{
    ...
    tMainSingleArray_SINGLE_CELL_CB.cTalker[ i ] = des.vdes;
}
...
tMainSingleArray_cTalker2_set_descriptor( int_t  i, Descriptor( sHello ) des )
{
    ...
    tMainSingleArray_SINGLE_CELL_CB.cTalker2[ i ] = des.vdes;
}
...
{
    tMainSingleArray_SINGLE_CELL_CB.cTalker2[ i ] = NULL;
}
