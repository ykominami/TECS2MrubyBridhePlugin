...
#define tMainSingletonForComp_cDefaultTalker_hello( ) \
	  tMainSingletonForComp_SINGLE_CELL_CB.cDefaultTalker->VMT->hello__T( \
	  tMainSingletonForComp_SINGLE_CELL_CB.cDefaultTalker )
...
tMainSingletonForComp_cDefaultTalker_refer_to_descriptor(  )
{
    ...
    des.vdes = (struct tag_sHello_VDES *)tMainSingletonForComp_SINGLE_CELL_CB.cDefaultTalker;
    return des;
}
