...
extern struct tag_sHello_VDES Talker3_eHello_des;
...
extern struct tag_sHello_VDES rComposite_Talker3_eHello_des;
...
struct tag_sHello_VDES * const rComposite_Selector_cHello[] = {
    ...
    &rComposite_Talker3_eHello_des,
    &rComposite_Talker4_eHello_des,
};

/* 属性・変数の配列 #_AVAI_# */
/* セル CB #_CB_# */
struct tag_tTalkerSelector_CB tTalkerSelector_CB_tab[] = {
