...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_tMainSingleArrayForComp_INIB {
    /* call port #_TCP_# */
    struct tag_sHello_VDES const*cDefaultTalker;
    struct tag_sHello_VDES *const*cTalker_init_;
    struct tag_sHello_VDES **cTalker;
    int_t n_cTalker;
    struct tag_sHello_VDES *const*cTalker2_init_;
    struct tag_sHello_VDES **cTalker2;
    /* call port #_NEP_# */ 
}  tMainSingleArrayForComp_INIB;

/* CB は存在しない。INIB を CB の代わりに使用するための define #_DCI_# */
#define tMainSingleArrayForComp_CB_tab           tMainSingleArrayForComp_INIB_tab
#define tMainSingleArrayForComp_SINGLE_CELL_CB   tMainSingleArrayForComp_SINGLE_CELL_INIB
#define tMainSingleArrayForComp_CB               tMainSingleArrayForComp_INIB
#define tag_tMainSingleArrayForComp_CB           tag_tMainSingleArrayForComp_INIB

/* シングルトンセル CB プロトタイプ宣言 #_SCP_# */
extern  tMainSingleArrayForComp_INIB  tMainSingleArrayForComp_SINGLE_CELL_INIB;


/* セルタイプのIDX型 #_CTIX_# */
typedef const struct tag_tMainSingleArrayForComp_INIB *tMainSingleArrayForComp_IDX;
...
#define N_CP_cTalker  (tMainSingleArrayForComp_SINGLE_CELL_INIB.n_cTalker)
#define NCP_cTalker   (tMainSingleArrayForComp_SINGLE_CELL_INIB.n_cTalker)
...
#define tMainSingleArrayForComp_cDefaultTalker_hello( ) \
	  tMainSingleArrayForComp_SINGLE_CELL_INIB.cDefaultTalker->VMT->hello__T( \
	  tMainSingleArrayForComp_SINGLE_CELL_INIB.cDefaultTalker )
#define tMainSingleArrayForComp_cTalker_hello( subscript ) \
	  tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker[subscript]->VMT->hello__T( \
	  tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker[subscript] )
#define tMainSingleArrayForComp_cTalker2_hello( subscript ) \
	  tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker2[subscript]->VMT->hello__T( \
	  tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker2[subscript] )
...
tMainSingleArrayForComp_cDefaultTalker_refer_to_descriptor(  )
{
    ...
    des.vdes = (struct tag_sHello_VDES *)tMainSingleArrayForComp_SINGLE_CELL_INIB.cDefaultTalker;
    return des;
}
...
tMainSingleArrayForComp_cTalker_set_descriptor( int_t  i, Descriptor( sHello ) des )
{
    ...
    tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker[ i ] = des.vdes;
}
...
tMainSingleArrayForComp_cTalker2_set_descriptor( int_t  i, Descriptor( sHello ) des )
{
    ...
    tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker2[ i ] = des.vdes;
}
...
{
    tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker2[ i ] = NULL;
}
...
#define INITIALIZE_CB()\
     {                                                                          \
        ...
        for( j = 0; j < N_CP_cTalker; j++ ){                                    \
            tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker[j] = tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker_init_[j];\
        }                                                                       \
       }                                                                        \
     {                                                                          \
        int_t   j;                                                              \
        for( j = 0; j < N_CP_cTalker2; j++ ){                                   \
            tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker2[j] = tMainSingleArrayForComp_SINGLE_CELL_INIB.cTalker2_init_[j];\
        }                                                                       \
       }                                                                        
