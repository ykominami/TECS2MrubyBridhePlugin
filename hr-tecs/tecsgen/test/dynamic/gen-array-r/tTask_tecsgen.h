...
/* 属性アクセスマクロ #_AAM_# */
#define tTask_ATTR_taskAttribute( p_that )	((p_that)->taskAttribute)
#define tTask_ATTR_exceptionAttribute( p_that )	((p_that)->exceptionAttribute)
#define tTask_ATTR_priority( p_that )	((p_that)->priority)
#define tTask_ATTR_stackSize( p_that )	((p_that)->stackSize)
#define tTask_ATTR_name( p_that )	((p_that)->name)

#define tTask_GET_taskAttribute(p_that)	((p_that)->taskAttribute)
#define tTask_GET_exceptionAttribute(p_that)	((p_that)->exceptionAttribute)
#define tTask_GET_priority(p_that)	((p_that)->priority)
#define tTask_GET_stackSize(p_that)	((p_that)->stackSize)
#define tTask_GET_name(p_that)	((p_that)->name)
...
#define tTask_cBody_main( p_that ) \
	  tSerialTaskBody_eTaskBody_main( \
	   &tSerialTaskBody_CB_tab[0] )
