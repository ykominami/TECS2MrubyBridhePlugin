...
/* 受け口関数プロトタイプ宣言 #_EPP_# */
/* sSig2 */
void         tCelltype_eEnt2_funcX(tCelltype_IDX idx);
void         tCelltype_eEnt2_funcX2(tCelltype_IDX idx);
void         tCelltype_eEnt2_funcX3(tCelltype_IDX idx);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
/* 受け口関数マクロ（短縮形） #_EPM_# */
#define eEnt2_funcX      tCelltype_eEnt2_funcX
#define eEnt2_funcX2     tCelltype_eEnt2_funcX2
#define eEnt2_funcX3     tCelltype_eEnt2_funcX3
