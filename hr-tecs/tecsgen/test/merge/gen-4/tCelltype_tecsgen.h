...
/* 受け口関数プロトタイプ宣言 #_EPP_# */
/* sSig2 */
void         tCelltype_eEntX_funcX(tCelltype_IDX idx);
void         tCelltype_eEntX_funcX2(tCelltype_IDX idx);
void         tCelltype_eEntX_funcX3(tCelltype_IDX idx);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
/* 受け口関数マクロ（短縮形） #_EPM_# */
#define eEntX_funcX      tCelltype_eEntX_funcX
#define eEntX_funcX2     tCelltype_eEntX_funcX2
#define eEntX_funcX3     tCelltype_eEntX_funcX3
