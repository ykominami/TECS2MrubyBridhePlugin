...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_tSendRecvServ_INIB {
    /* call port #_TCP_# */
    /* call port #_NEP_# */ 
}  tSendRecvServ_INIB;

/* CB は存在しない。INIB を CB の代わりに使用するための define #_DCI_# */
#define tSendRecvServ_CB_tab           tSendRecvServ_INIB_tab
#define tSendRecvServ_SINGLE_CELL_CB   tSendRecvServ_SINGLE_CELL_INIB
#define tSendRecvServ_CB               tSendRecvServ_INIB
#define tag_tSendRecvServ_CB           tag_tSendRecvServ_INIB

extern tSendRecvServ_CB  tSendRecvServ_CB_tab[];

/* セルタイプのIDX型 #_CTIX_# */
typedef const struct tag_tSendRecvServ_INIB *tSendRecvServ_IDX;
...
/* セルCBを得るマクロ #_GCB_# */
#define tSendRecvServ_GET_CELLCB(idx) (idx)
 /* 呼び口関数マクロ #_CPM_# */
...
#define FOREACH_CELL(i,p_cb)   \
    for( (i) = 0; (i) < tSendRecvServ_N_CELL; (i)++ ){ \
       (p_cb) = &tSendRecvServ_CB_tab[i];
