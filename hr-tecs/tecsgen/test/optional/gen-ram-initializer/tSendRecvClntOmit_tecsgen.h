...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_tSendRecvClntOmit_INIB {
    /* call port #_TCP_# */
    /* call port #_NEP_# */ 
}  tSendRecvClntOmit_INIB;

/* CB は存在しない。INIB を CB の代わりに使用するための define #_DCI_# */
#define tSendRecvClntOmit_CB_tab           tSendRecvClntOmit_INIB_tab
#define tSendRecvClntOmit_SINGLE_CELL_CB   tSendRecvClntOmit_SINGLE_CELL_INIB
#define tSendRecvClntOmit_CB               tSendRecvClntOmit_INIB
#define tag_tSendRecvClntOmit_CB           tag_tSendRecvClntOmit_INIB

extern tSendRecvClntOmit_CB  tSendRecvClntOmit_CB_tab[];

/* セルタイプのIDX型 #_CTIX_# */
typedef const struct tag_tSendRecvClntOmit_INIB *tSendRecvClntOmit_IDX;
...
/* セルCBを得るマクロ #_GCB_# */
#define tSendRecvClntOmit_GET_CELLCB(idx) (idx)
 /* 呼び口関数マクロ #_CPM_# */
...
#define FOREACH_CELL(i,p_cb)   \
    for( (i) = 0; (i) < tSendRecvClntOmit_N_CELL; (i)++ ){ \
       (p_cb) = &tSendRecvClntOmit_CB_tab[i];
