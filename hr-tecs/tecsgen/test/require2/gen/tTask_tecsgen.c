...
extern struct tag_sTaskBody_VDES rRegion_Cell_eBody_des;
...
tTask_INIB tTask_INIB_tab[] = {
    ...
    {
        /* call port (INIB) #_CP_# */ 
        &rRegion_Cell_eBody_des,                 /* cBody #_CCP1_# */
        0,                                       /* #_CCP5_# */
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        TA_ACT,                                  /* taskAttribute */
...
extern const struct tag_tTask_eTask_DES rRegion_Task_eTask_des;
const struct tag_tTask_eTask_DES rRegion_Task_eTask_des = {
    &tTask_eTask_MT_,
    &tTask_CB_tab[1],     /* CB */
};
