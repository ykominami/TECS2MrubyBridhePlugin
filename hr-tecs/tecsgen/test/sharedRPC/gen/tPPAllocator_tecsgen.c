...
/* 属性・変数の配列 #_AVAI_# */
int8_t tPPAllocator_PPAllocator_RPCSharedChannel_CB_buf_INIT[64];
/* セル INIB #_INIB_# */
tPPAllocator_INIB tPPAllocator_INIB_tab[] = {
    /* cell: tPPAllocator_CB_tab[0]:  PPAllocator_RPCSharedChannel id=1 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        64,                                      /* heapSize */
        tPPAllocator_PPAllocator_RPCSharedChannel_CB_buf_INIT, /* buf */
    },
};
