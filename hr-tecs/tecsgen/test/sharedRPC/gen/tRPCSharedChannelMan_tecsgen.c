...
tRPCSharedChannelMan_INIB tRPCSharedChannelMan_INIB_tab[] = {
    /* cell: tRPCSharedChannelMan_CB_tab[0]:  RPCSharedChannel_RPCChannelMan id=1 */
    {
        /* entry port #_EP_# */ 
        2,                                       /*  #_EEP_# */
    },
...
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_tRPCSharedChannelMan_eSemaphore_DES rRegion_RPCSharedChannel_RPCChannelMan_eSemaphore_des0;
const struct tag_tRPCSharedChannelMan_eSemaphore_DES rRegion_RPCSharedChannel_RPCChannelMan_eSemaphore_des0 = {
    0,
    &tRPCSharedChannelMan_INIB_tab[0],    /* INIB */
    0
};
extern const struct tag_tRPCSharedChannelMan_eSemaphore_DES rRegion_RPCSharedChannel_RPCChannelMan_eSemaphore_des1;
const struct tag_tRPCSharedChannelMan_eSemaphore_DES rRegion_RPCSharedChannel_RPCChannelMan_eSemaphore_des1 = {
    0,
    &tRPCSharedChannelMan_INIB_tab[0],    /* INIB */
    1
};
