...
struct tag_sAlloc_VMT {
    ER             (*alloc__T)( const struct tag_sAlloc_VDES *edp, int32_t size, void** ptr );
    ER             (*dealloc__T)( const struct tag_sAlloc_VDES *edp, const void* ptr );
    ER             (*printStatistics__T)( const struct tag_sAlloc_VDES *edp );
};
...
#define	FUNCID_SALLOC_PRINTSTATISTICS          (3)
