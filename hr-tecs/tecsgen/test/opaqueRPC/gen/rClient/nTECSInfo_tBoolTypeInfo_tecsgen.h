...
#define nTECSInfo_tBoolTypeInfo_SINGLE_CELL_CB   nTECSInfo_tBoolTypeInfo_SINGLE_CELL_INIB
...
void         nTECSInfo_tBoolTypeInfo_eTypeInfo_getNameLength(nTECSInfo_tBoolTypeInfo_IDX idx, uint16_t* len);
void         nTECSInfo_tBoolTypeInfo_eTypeInfo_getSize(nTECSInfo_tBoolTypeInfo_IDX idx, uint32_t* size);
void         nTECSInfo_tBoolTypeInfo_eTypeInfo_getKind(nTECSInfo_tBoolTypeInfo_IDX idx, int8_t* kind);
void         nTECSInfo_tBoolTypeInfo_eTypeInfo_getNType(nTECSInfo_tBoolTypeInfo_IDX idx, int32_t* num);
void         nTECSInfo_tBoolTypeInfo_eTypeInfo_getTypeInfo(nTECSInfo_tBoolTypeInfo_IDX idx, int32_t ith, Descriptor( nTECSInfo_sTypeInfo )* desc);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define nTECSInfo_tBoolTypeInfo_ATTR_bitSize( p_that )	((p_that)->bitSize)
...
#define nTECSInfo_tBoolTypeInfo_GET_bitSize(p_that)	((p_that)->bitSize)
...
#define ATTR_bitSize         nTECSInfo_tBoolTypeInfo_ATTR_bitSize( p_cellcb )
