...
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_nTECSInfo_tBoolTypeInfo_eTypeInfo_DES rClient_rTECSInfo_bool_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tBoolTypeInfo_eTypeInfo_DES rClient_rTECSInfo_bool_tTypeInfo_eTypeInfo_des = {
