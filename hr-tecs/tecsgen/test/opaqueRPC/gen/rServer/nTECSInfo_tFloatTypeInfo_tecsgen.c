...
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_nTECSInfo_tFloatTypeInfo_eTypeInfo_DES rServer_rTECSInfo_float32_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tFloatTypeInfo_eTypeInfo_DES rServer_rTECSInfo_float32_tTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tFloatTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tFloatTypeInfo_INIB_tab[0],   /* INIB */
};
extern const struct tag_nTECSInfo_tFloatTypeInfo_eTypeInfo_DES rServer_rTECSInfo_double64_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tFloatTypeInfo_eTypeInfo_DES rServer_rTECSInfo_double64_tTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tFloatTypeInfo_eTypeInfo_MT_,
