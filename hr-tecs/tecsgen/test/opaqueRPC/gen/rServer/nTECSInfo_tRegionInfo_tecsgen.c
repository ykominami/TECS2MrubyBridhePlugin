...
nTECSInfo_tRegionInfo_INIB nTECSInfo_tRegionInfo_INIB_tab[] = {
    ...
    /* cell: nTECSInfo_tRegionInfo_CB_tab[1]:  rServer_rSPonRegionInfo id=2 */
    {
        /* call port (INIB) #_CP_# */ 
        0,                                       /* #_CCP9_# */
        0,                                       /* length of cCellInfo (n_cCellInfo) #_CCP6_# */
    ...
    /* cell: nTECSInfo_tRegionInfo_CB_tab[2]:  rServer_rTECSInfoRegionInfo id=3 */
    {
        /* call port (INIB) #_CP_# */ 
        0,                                       /* #_CCP9_# */
        0,                                       /* length of cCellInfo (n_cCellInfo) #_CCP6_# */
...
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_nTECSInfo_tRegionInfo_eRegionInfo_DES rServer_rTECSInfo__LinkRootRegionInfo_eRegionInfo_des;
const struct tag_nTECSInfo_tRegionInfo_eRegionInfo_DES rServer_rTECSInfo__LinkRootRegionInfo_eRegionInfo_des = {
    &nTECSInfo_tRegionInfo_eRegionInfo_MT_,
    &nTECSInfo_tRegionInfo_INIB_tab[0],   /* INIB */
};
extern const struct tag_nTECSInfo_tRegionInfo_eRegionInfo_DES rServer_rTECSInfo_rServer_rSPonRegionInfo_eRegionInfo_des;
const struct tag_nTECSInfo_tRegionInfo_eRegionInfo_DES rServer_rTECSInfo_rServer_rSPonRegionInfo_eRegionInfo_des = {
    &nTECSInfo_tRegionInfo_eRegionInfo_MT_,
    &nTECSInfo_tRegionInfo_INIB_tab[1],   /* INIB */
};
extern const struct tag_nTECSInfo_tRegionInfo_eRegionInfo_DES rServer_rTECSInfo_rServer_rTECSInfoRegionInfo_eRegionInfo_des;
const struct tag_nTECSInfo_tRegionInfo_eRegionInfo_DES rServer_rTECSInfo_rServer_rTECSInfoRegionInfo_eRegionInfo_des = {
    &nTECSInfo_tRegionInfo_eRegionInfo_MT_,
