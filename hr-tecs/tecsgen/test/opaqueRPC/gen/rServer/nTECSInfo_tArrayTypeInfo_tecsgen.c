...
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array4_TypeInfo_eTypeInfo_des;

extern struct tag_nTECSInfo_sTypeInfo_VDES rServer_rTECSInfo_const__int8_tTypeInfo_eTypeInfo_des;

extern struct tag_nTECSInfo_sTypeInfo_VDES rServer_rTECSInfo_const__STATypeInfo_eTypeInfo_des;

extern struct tag_nTECSInfo_sTypeInfo_VDES rServer_rTECSInfo_const__STA_Ptr_TypeInfo_eTypeInfo_des;
...
extern struct tag_nTECSInfo_sTypeInfo_VDES rServer_rTECSInfo_intTypeInfo_eTypeInfo_des;
...
nTECSInfo_tArrayTypeInfo_INIB nTECSInfo_tArrayTypeInfo_INIB_tab[] = {
    ...
    {
        /* call port (INIB) #_CP_# */ 
        (struct tag_nTECSInfo_sTypeInfo_VDES *)&rServer_rTECSInfo_const__int8_t_Array4_TypeInfo_eTypeInfo_des, /* cTypeInfo #_CCP1_# */
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
    ...
    {
        /* call port (INIB) #_CP_# */ 
        &rServer_rTECSInfo_const__STA_Ptr_TypeInfo_eTypeInfo_des, /* cTypeInfo #_CCP1_# */
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        "const STA*[2]",                         /* name */
        5,                                       /* typeKind */
    ...
    {
        /* call port (INIB) #_CP_# */ 
        &rServer_rTECSInfo_intTypeInfo_eTypeInfo_des, /* cTypeInfo #_CCP1_# */
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        "int[1]",                                /* name */
        5,                                       /* typeKind */
...
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_intptr_t_Array6_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_intptr_t_Array6_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[0],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array64_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array64_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[1],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array4__Array64_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array4__Array64_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[2],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array4_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__int8_t_Array4_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[3],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__STA_Array2_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__STA_Array2_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[4],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__STA_Ptr__Array2_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_const__STA_Ptr__Array2_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[5],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_int8_t_Array64_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_int8_t_Array64_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[6],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_STA_Ptr__Array2_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_STA_Ptr__Array2_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[7],   /* INIB */
};
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_int_Array1_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rServer_rTECSInfo_int_Array1_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
