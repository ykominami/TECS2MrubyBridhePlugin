#ifndef tAlarm__INLINE_H
#define tAlarm__INLINE_H
 ...
 *
 * 呼び口関数 #_TCPF_#
 * call port: cBody signature: sCallbackBody context:non-task optional:true
 *   bool_t     is_cBody_joined()                     check if joined
 *   void           cBody_main( );
 *
 * #[</PREAMBLE>]# */
