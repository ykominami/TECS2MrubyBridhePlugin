...
typedef const struct tag_tCtR2_INIB {
    /* call port #_TCP_# */
    struct tag_sSig2_VDES const*cCall2;
    struct tag_sSig3_VDES const*cCall3;
    /* call port #_NEP_# */ 
}  tCtR2_INIB;
...
#define tCtR2_cCall2_func1( p_that, arg1, res ) \
	  (p_that)->cCall2->VMT->func1__T( \
	   (p_that)->cCall2, (arg1), (res) )
#define tCtR2_cCall3_func1( p_that, arg1, res ) \
	  (p_that)->cCall3->VMT->func1__T( \
	   (p_that)->cCall3, (arg1), (res) )
...
#define cCall2_func1( arg1, res ) \
          tCtR2_cCall2_func1( p_cellcb, arg1, res )
#define cCall3_func1( arg1, res ) \
          tCtR2_cCall3_func1( p_cellcb, arg1, res )
