...
typedef const struct tag_tCell3_INIB {
    /* call port #_TCP_# */
    const struct tag_tCell4_INIB * cCall3;
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
    int32_t        a;
}  tCell3_INIB;
...
/* 受け口関数プロトタイプ宣言 #_EPP_# */
/* sSig3 */
int32_t      tCell3_eEntry3_func1(tCell3_IDX idx, int32_t a);
int32_t      tCell3_eEntry3_func2(tCell3_IDX idx, int32_t a);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define tCell3_ID_BASE              (1)  /* ID のベース  #_NIDB_# */
