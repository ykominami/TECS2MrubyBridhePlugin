...
typedef const struct tag_tCell2_INIB {
    /* call port #_TCP_# */
    const struct tag_tCell3_INIB * cCall2;
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
    int32_t        a;
}  tCell2_INIB;
...
#define tCell2_GET_a(p_that)	((p_that)->a)
 ...
 /* 呼び口関数マクロ #_CPM_# */
#define tCell2_cCall2_func1( p_that, a ) \
	  tCell3_eEntry3_func1( \
	   (p_that)->cCall2, (a) )
#define tCell2_cCall2_func2( p_that, a ) \
	  tCell3_eEntry3_func2( \
	   (p_that)->cCall2, (a) )
...
/* 呼び口関数マクロ（短縮形）#_CPMA_# */
#define cCall2_func1( a ) \
          ((void)p_cellcb, tCell2_cCall2_func1( p_cellcb, a ))
#define cCall2_func2( a ) \
          ((void)p_cellcb, tCell2_cCall2_func2( p_cellcb, a ))
