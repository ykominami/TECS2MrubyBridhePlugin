...
#endif /* __cplusplus */
/* セル CB 型宣言 #_CCTPO_# */
typedef struct tag_tSCt_no_CB_a_INIB_CB {
    /* attribute #_AT_# */ 
    int32_t        size;
    int8_t*        buf;
    /* var #_VA_# */ 
}  tSCt_no_CB_a_INIB_CB;
/* シングルトンセル CB プロトタイプ宣言 #_SCP_# */
extern  tSCt_no_CB_a_INIB_CB  tSCt_no_CB_a_INIB_SINGLE_CELL_CB;


/* セルタイプのIDX型 #_CTIX_# */
typedef struct tag_tSCt_no_CB_a_INIB_CB *tSCt_no_CB_a_INIB_IDX;
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
/* 属性アクセスマクロ #_AAM_# */
#define tSCt_no_CB_a_INIB_ATTR_size	(tSCt_no_CB_a_INIB_SINGLE_CELL_CB.size)

#define tSCt_no_CB_a_INIB_GET_size()	(tSCt_no_CB_a_INIB_SINGLE_CELL_CB.size)


/* var アクセスマクロ #_VAM_# */
#define tSCt_no_CB_a_INIB_VAR_buf	(tSCt_no_CB_a_INIB_SINGLE_CELL_CB.buf)
