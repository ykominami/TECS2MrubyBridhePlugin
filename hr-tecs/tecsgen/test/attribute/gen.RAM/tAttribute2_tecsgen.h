...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_tAttribute2_INIB {
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
...
#define tAttribute2_CB_tab           tAttribute2_INIB_tab
#define tAttribute2_SINGLE_CELL_CB   tAttribute2_SINGLE_CELL_INIB
#define tAttribute2_CB               tAttribute2_INIB
#define tag_tAttribute2_CB           tag_tAttribute2_INIB

extern tAttribute2_CB  tAttribute2_CB_tab[];

/* セルタイプのIDX型 #_CTIX_# */
typedef const struct tag_tAttribute2_INIB *tAttribute2_IDX;
