...
#endif /* __cplusplus */
/* セル INIB 型宣言 #_CIP_# */
typedef const struct tag_tAttribute_INIB {
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
    uint32_t       size;
    uint32_t       size2;
...
#define tAttribute_ATTR_size2( p_that )	((p_that)->_inib->size2)
#define tAttribute_ATTR_size_array( p_that )	((p_that)->_inib->size_array)
#define tAttribute_ATTR_ptr( p_that )	((p_that)->_inib->ptr)
#define tAttribute_ATTR_very_long_name_more_than_16char( p_that )	((p_that)->_inib->very_long_name_more_than_16char)
#define tAttribute_ATTR_msg( p_that )	((p_that)->_inib->msg)

#define tAttribute_GET_size(p_that)	((p_that)->_inib->size)
#define tAttribute_GET_size2(p_that)	((p_that)->_inib->size2)
#define tAttribute_GET_size_array(p_that)	((p_that)->_inib->size_array)
#define tAttribute_GET_ptr(p_that)	((p_that)->_inib->ptr)
#define tAttribute_GET_very_long_name_more_than_16char(p_that)	((p_that)->_inib->very_long_name_more_than_16char)
#define tAttribute_GET_msg(p_that)	((p_that)->_inib->msg)


/* var アクセスマクロ #_VAM_# */
#define tAttribute_VAR_sz_array(p_that)	((p_that)->_inib->sz_array)
...
#define SET_CB_INIB_POINTER(i,p_that)\
	(p_that)->_inib = &tAttribute_INIB_tab[(i)];
