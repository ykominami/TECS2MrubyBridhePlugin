...
/* セルタイプのIDX型 #_CTIX_# */
typedef ID tSample_IDX;

/* 受け口関数プロトタイプ宣言 #_EPP_# */
/* sSimple */
void         tSample_eSample_helloWorld(tSample_IDX idx);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define tSample_VALID_IDX(IDX) (tSample_ID_BASE <= (IDX) && (IDX) < tSample_ID_BASE+tSample_N_CELL)
...
/* 受け口関数マクロ（短縮形） #_EPM_# */
#define eSample_helloWorld tSample_eSample_helloWorld
