...
#define TNUM_DOMID	1
#define TNUM_TSKID	63
#define TNUM_SEMID	31
#define TNUM_FLGID	21
...
#define TSKID_tTask_EV3Task	12
#define TSKID_tTask_MrubyTask1	13
#define TSKID_tTask_MrubyTask2	14
#define ZMODEM_RECV_TASK	15
...
#define SEMID_tSemaphore_Semaphore	15
#define BTN_CLICK_FLG	1
#define CONSOLE_BTN_CLICK_FLG	2
#define USBMSC_EVT_FLG	3
#define FLGID_tEventflag_Eventflag_begin	4
#define FLGID_tEventflag_Eventflag_end	5
#define DISKIO_MTX	1
...
#define BT_DMA_CYC	4
#define CYCHDLRID_tCyclicHandler_RiteVMScheduler_CyclicHandler	5
